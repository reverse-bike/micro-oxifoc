//! Per-control-period PI law with external saturation back-calculation.

use super::numeric::{Fixed, Scalar};

#[derive(Clone, Copy, Debug, PartialEq)]
pub struct Pi<N: Scalar = Fixed> {
    proportional_gain: N,
...
mod tests {
    ...
    fn fixed_pi() -> Pi<Fixed> {
        Pi::new(Fixed::ratio(512, 1_024), Fixed::ratio(605, 16_384))
    }
    ...
    fn fixed_and_float_run_the_same_pi_law() {
        ...
        let mut floating = Pi::new(0.5_f32, 605.0 / 16_384.0);
